...
public class Field {
	...
	private List<ScoreRow> pointField = new ArrayList<ScoreRow>();

	/*
	 * Defines a row in the pointfield name - name of the row eval_variant -
	 * names the evaluation variant points - points if there are any in the
	 * field
	 */
	...
	public List<ScoreRow> getpointfield() {
		return pointField;
	}
	...
	public class ScoreRow {
		...
		public String toString() {
			...
			return name + ";" + eval_variant + ";" + points;
		}
	}
